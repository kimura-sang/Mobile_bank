...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> Notifications> Groups
        </h3>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <?foreach ($notificationGroupList as $key => $value){?>
                            <tr class="odd gradeX">
                                <td><?=$key + 1?></td>
                                ...
                                <td>
                                    <button class="btn btn-outline btn-circle btn-sm purple" onclick="pageMove('/notification/groupDetail?groupNotificationId=<?=$value['id']?>')"><i class="fa fa-edit"></i> Detail</button>
