...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> Notifications> push
        </h3>
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <button class="btn btn-outline btn-circle btn-sm purple" onclick="pageMove('/notification/pushDetail?pushId=<?=$value['id']?>')"><i class="fa fa-edit"></i> Detail</button>
