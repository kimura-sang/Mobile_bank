                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> Managed Admin Table</span>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td style="">
                                    ...
                                    <button class="btn btn-outline btn-circle btn-sm purple" onclick="pageMove('/admin/adminDetail?adminId=<?=$value['id']?>')"><i class="fa fa-edit"></i> Detail</button>
