                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> Managed Group Table</span>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <?if ($value['contribution_active_status'] = 1) {?>
                                    <td>On</td>
                                    <?}
                                    else{?><td>Off</td> <?
                                }?>
                                <td> <?=$value['goal_count']?></td>
                                <td style="">
                                    <button class="btn btn-outline btn-circle btn-sm blue"><i class="fa fa-archive"></i> Edit</button>
                                    <button class="btn btn-outline btn-circle btn-sm purple" onclick="pageMove('/group/groupDetail?groupId=<?=$value['id']?>')"><i class="fa fa-edit"></i> Detail</button>
