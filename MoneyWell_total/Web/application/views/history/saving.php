...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> Histories> Savings
        </h3>
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><?=$value['saved_datetime']?></td>
                                <td style="">
                                    <button class="btn btn-outline btn-circle btn-sm purple" onclick="pageMove('/history/savingDetail?savingTransactionId=<?=$value['id']?>')"><i class="fa fa-edit"></i> Detail</button>
