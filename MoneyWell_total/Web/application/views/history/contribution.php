...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> Histories> Contributions
        </h3>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <?foreach ($contributionList as $key => $value){?>
                            <tr class="odd gradeX">
                                <td><?=$key + 1?></td>
                                <td><?=$value['sender_name'] ?></td>
                                <td><?=$value['receiver_name']?></td>
                                <td><?=$value['group_name']?></td>
                                <td><?=$value['amount']?> GBP</td>
                                <td><?=$value['applied_datetime']?></td>
                                <td style="">
                                    <button class="btn btn-outline btn-circle btn-sm purple" onclick="pageMove('/history/contributionDetail?contributionId=<?=$value['id']?>')"><i class="fa fa-edit"></i> Detail</button>
