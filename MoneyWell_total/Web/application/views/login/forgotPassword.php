...
<div class="logo" style="width: 1000px;">
    <!--    <a href="index.html">-->
    <img src="<?=SERVER_ADDRESS ?>/include/img/logo_image.png" style="height: 80px; margin-left: 0px;" alt="" /> </a>
    <Label style="font-size: 20px; color: #000; font-weight: 100; margin-left: 10px;">MONEYWELL</Label>
    <div class="form-actions" style="display: inline-flex; align-items: center;">
        <label class="login-tip" style="margin-left: 400px">Already have an account?</label>
        <button type="submit" class="btn green btn-block uppercase" onclick="pageMove('/login'); return false;">SIGN IN</button>
    </div>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    ...
    <form class="login-form" action="" method="post" id="mainFrm">
        <div class="alert alert-danger display-hide" style="background-color: white; border-color: #c5bec5; border-radius: 5px !important;" id="error_div">
            ...
            <span id="error" style="color: #544c4c;"> Enter your Email. </span>
        </div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn green btn-block uppercase" onclick="tryLogin('userId', 'pwd', '/login/tryLogin'); return false;">Send</button>
        </div>
    </form>
</div>
