...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> Settings> Donation List
        </h3>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr class="odd gradeX">
                                <td><?=$key + 1?></td>
                                <td><img src="<?=$value['photo_url']?>" class="img-responsive" style="height: 40px; width: 40px;"></td>
                                <td><?=$value['name']?></td>
                                <td><?=$value['amount']?> GBP</td>
                                <td style="">
                                    <button class="btn btn-outline btn-circle btn-sm blue"><i class="fa fa-archive"></i> Edit</button>
                                    <button class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Detail</button>
