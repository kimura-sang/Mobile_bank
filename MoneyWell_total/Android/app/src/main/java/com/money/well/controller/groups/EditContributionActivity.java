...
public class EditContributionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thisActivity = this;
        thisContext = this;
        thisView = findViewById(R.id.activity_edit_contribution);
    ...
    private void initBasicUI(){
        ...
        txtTopTitle.setText(R.string.title_edit_contribution);
